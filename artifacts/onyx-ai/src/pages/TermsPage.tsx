...
// Accesible con o sin sesión (se enlaza desde el login).
  ...
  <div className="max-w-3xl mx-auto px-4 py-8 md:px-8">
    ...
    <div className="space-y-8 text-sm leading-relaxed text-foreground/90">
      ...
      <section className="space-y-3">
        ...
        <p>Para utilizar el Servicio, es necesario crear una cuenta. Eres responsable de:</p>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          esta opción en Configuración → Privacidad.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          No reclamamos propiedad sobre el contenido que generas, pero no garantizamos que sea libre de
      ...
      <section className="space-y-3">
        ...
        <p>ZerCX AI se proporciona "tal cual". No garantizamos:</p>
        <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
          <li>Disponibilidad ininterrumpida del Servicio.</li>
          <li>Que las respuestas de la IA sean precisas o completas.</li>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          También podemos actualizar estos Términos; te notificaremos de cambios significativos.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          Podemos suspender o eliminar tu cuenta si violas estos Términos. También puedes eliminar tu
          cuenta en cualquier momento desde la Configuración de la aplicación.
        </p>
      </section>
...
export default function TermsPage() {
  ...
  // Authenticated → show inside the full app layout with sidebar
  if (!isLoading && user) {
    return (
      <AppLayout>
  ...
  // Unauthenticated (or still loading) → standalone page, no sidebar required
  return (
